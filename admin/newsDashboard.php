						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu bg-danger" aria-labelledby="navbarDropdownMenuLink">
								<li><a class="dropdown-item bg-danger text-white fw-bold text-center"
										href="newsDashboard.php?logout='1'">logout</a></li>
							</ul>
						</li>
						<?php
}
				...
				<table class="table table-lg  table-striped  align-middle">
					<thead class="table-dark">
						<tr>
							...
							<th class="text-center border" colspan="3"><strong>Action</strong></th>
...
?>
						<tr>
							...
							<td>
								<?php echo $row["updated_datetime"]; ?>
							</td>

							<td>
								<a class="btn btn-success" href="../news.php?id=<?= $row["id"]; ?>">Details</a>
